...
void send_host_callback_request(conn_t *server, const void *dst,
  ...
  require(
      rpc_write(server, &wire.function_token, sizeof(wire.function_token)) == 0,
...
void test_host_callback_allocation_failure_drains_message() {
  ...
  require(
      lupine_register_host_callback(&pair.client, test_registered_host_callback,
...
void test_host_callback_malformed_frame_poisons_connection() {
  ...
  require(lupine_register_host_callback(&pair.client,
                                        test_registered_host_callback,
  ...
  require(pair.client.closed, "malformed frame did not poison the connection");
